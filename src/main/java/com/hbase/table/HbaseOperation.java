	 ...
	 /**
	    ...
	    public static void main(String[] agrs) {
	        try {
	            ...
	            HbaseOperation.addRecord(tablename, "zkb", "course", "math", "97");
	            HbaseOperation.addRecord(tablename, "zkb", "course", "art", "87");
	            // add record baoniu
	            HbaseOperation.addRecord(tablename, "baoniu", "grade", "", "4");
	            HbaseOperation.addRecord(tablename, "baoniu", "course", "math", "89");
	 
	            System.out.println("===========get one record========");
	            HbaseOperation.getOneRecord(tablename, "zkb");
